...
const FloorDesigner = ({ tables, setTables, sections, setSections, loadTables }) => {
  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh - 75px)', background: '#f8fafc', overflow: 'hidden' }} className="animate-fade-in">
      ...
      {tableToDelete && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(15, 23, 42, 0.65)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 999999, padding: '20px' }}>
