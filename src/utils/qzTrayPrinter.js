...
export async function connectQzTray() {
  ...
  try {
    // ─── QZ Tray Demo Certificate (from Site Manager) ─────────
    // Providing a real certificate enables the "Remember" checkbox.
    // After clicking "Remember + Allow" once, the popup never appears again.
    const QZ_CERTIFICATE = `-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----`;
    ...
    qz.security.setSignaturePromise((toSign) => (resolve, reject) => {
      resolve('');  // Demo cert — no signing needed
    });
